...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    instructions: [
      'Open battery package; use flattened packaging as a clean working surface',
      'Use 2 people to lift each Battery Block — 121 lbs each',
      'Floor mount: use tilt bracket; maintain 0.6–4 in. distance from wall',
      'Level the first Battery Block by adjusting its feet',
      'Stack additional Battery Blocks (up to 4 per stack); click each into place',
      'Attach Battery Link on top of the stack',
    ],
    diagramFiles: ['page-24', 'page-25', 'page-27', 'page-28', 'page-23'],
    hasPassCriteria: true,
    passNote: 'Battery Block LED blinks after Battery Link attachment → OK. No LED → FAIL. Contact SolarEdge support before proceeding.',
  },
  {
    id: 5,
    ...
    hasPassCriteria: true,
    passNote: 'Physical tug test — each wire must resist pull after lever is locked. Circuit breaker rating must match inverter datasheet.',
  },
  {
    id: 6,
    ...
    hasPassCriteria: true,
    passNote: 'DC polarity confirmed: + to +, − to −. Torque values met per wire gauge.',
  },
  {
    id: 7,
  ...
  },
  {
    ...
    hasPassCriteria: true,
    passNote: 'All LEDs non-red. Physical installation complete — proceed to GO commissioning.',
  },
];
